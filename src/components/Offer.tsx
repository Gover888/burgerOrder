...
function Offer(props) {
    return (
        <div className="bg-black h-screen flex flex-col md:flex-row md:justify-between md:bg-[url('/offerBg.png')] md:h-[70vh] w-full gap-10 m-0"
        >
            <div className=" flex-1 flex flex-col justify-center item-center gap-8 p-6 ">
